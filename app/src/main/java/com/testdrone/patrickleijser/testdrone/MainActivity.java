package com.testdrone.patrickleijser.testdrone;
...
import com.testdrone.patrickleijser.testdrone.controller.ARDrone20MediaCodecDecoder;
import com.testdrone.patrickleijser.testdrone.controller.ARDrone20MediaCodecDecoderCopy;
...
public class MainActivity extends Activity implements DroneVideoListener, OnSharedPreferenceChangeListener {
    ...
    private void droneOnConnected() {
        ...
        if (btnTakeOffOrLand != null) {
            ...
            btnTakeOffOrLand.setClickable(false);
            btnTakeOffOrLand.setEnabled(false);
